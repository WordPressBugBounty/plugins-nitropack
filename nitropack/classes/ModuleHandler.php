...
class ModuleHandler {
    ...
    private static $modules = [
        ...
        Integration\Server\NestifyCDN::class,
        ...
        Integration\Plugin\AeliaCurrencySwitcher::class,
        Integration\Plugin\MPG::class,
        Integration\Plugin\CURCY_MultiCurrency::class,
