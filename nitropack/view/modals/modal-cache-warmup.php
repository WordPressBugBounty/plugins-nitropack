<div id="modal-cache-warmup" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
	...
	<div class="modal-container">
		...
		<div class="modal-inner">
			<div class="popup-header">
				<button type="button" class="close-modal" data-modal-hide="modal-cache-warmup">
			...
			<div class="popup-footer" style="margin-bottom: 0;">
				<button type="button" data-modal-hide="modal-cache-warmup"
...
<script>
	jQuery(document).ready(function ($) {
		// const $targetEl = document.getElementById('modal-cache-warmup'),
		// 	modal_options = {
		// 		backdrop: 'static',
