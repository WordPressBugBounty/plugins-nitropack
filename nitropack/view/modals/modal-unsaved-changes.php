<div id="modal-unsavedChanges" data-modal-backdrop="" tabindex="-1" aria-hidden="true" class="hidden modal-wrapper popup-modal">
    <div class="popup-container">
        <div class="popup-inner">
            ...
            <div class="popup-header">
                ...
                <h3 class="text-center"><?php esc_html_e('You have unsaved changes.', 'nitropack'); ?><br>
                    <?php esc_html_e('Are you sure you want to leave this page?', 'nitropack'); ?></h3>
            </div>
            <!-- Modal body -->
            <div class="popup-body text-center"></div>

            <div class="popup-footer">
                <button type="button" class="btn btn-secondary popup-close"><?php esc_html_e('Leave', 'nitropack'); ?></button>
                <button type="button" class="btn btn-primary"><?php esc_html_e('Save', 'nitropack'); ?></button>
            </div>
        </div>
    </div>
</div>